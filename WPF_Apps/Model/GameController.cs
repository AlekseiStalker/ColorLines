...
namespace BallsAndLines.Model
{
    ...
    {
        public static readonly string GameStorePath = @"F:\Work_data\DBBest\DBBest_MyProjects\Sources\WPF_Apps\WPF_Apps\bin\Debug\SavedGame\";
        ...
        public static Board CreateNewGameBoard(int size, Board serializedBoard = null)
        {
            ...
            _board = serializedBoard == null ?  new Board() 
                                             :  serializedBoard;
        ...
        public static bool CanReplaceSelectedBallToCell(int toRow, int toCol) => 
            _board.IsPathExist(_selectedBall, _board[toRow, toCol]);
