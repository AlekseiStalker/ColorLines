...
namespace BallsAndLines.Model
{
    ...
    {
        //central point in target zone
        int _centralRow;
        int _centralCol;

        Cells2DList _boardCells;
        ...
        {
            List<List<Cell>> cellsOfPossibleLines = new List<List<Cell>>();
        ...
        public Color GetLastAddBallColor() =>  _boardCells[_centralRow][_centralCol].Ball.Color;
    }
}
